...
- **GPU 型号回退**：GPU 不足时按优先级自动尝试备选型号（每种型号重试 3 次，随机间隔 20-60s）
- **自动替换**：实例数量满足但存在回退型号时，尝试部署首选型号并替换回退实例
- **钉钉通知**：执行前发送计划通知，执行后发送结果通知（含型号分布和替换详情）
...
| 配置型号 | 回退顺序 |
|---------|---------|
| `NVIDIA GeForce RTX 4090` | 4090 → 4090 D → 4090 D 48G → 4090 48G |
| `NVIDIA GeForce RTX 4090 D` | 4090 D → 4090 → 4090 D 48G → 4090 48G |
| `NVIDIA GeForce RTX 4090 48G` | 4090 48G → 4090 D 48G |
| `NVIDIA GeForce RTX 4090 D 48G` | 4090 D 48G → 4090 48G |
